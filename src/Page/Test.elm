module Page.Test exposing (ExternalMsg(..), Model, Msg, initialModel, update, view)
...
type Msg
    ...
    | SetEmail String
    | SetPassword String
    | TestCompleted (Result Http.Error User)
    ...
    case msg of
        SubmitForm ->
            case validate modelValidator model of
                [] ->
                    { model | errors = [] }
                        => Http.send TestCompleted (Request.User.test model)
                        => NoOp
